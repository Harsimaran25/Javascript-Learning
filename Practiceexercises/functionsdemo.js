...
let sumofnum=function(c,d){ // there is no name of this function just keyword function
    return c+d;
}
...
//example 
function sub(a,b){ // this is function greet is scope inside this only 
...
if (1==1){// if is block not function
