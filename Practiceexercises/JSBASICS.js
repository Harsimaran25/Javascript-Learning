...
let string4 = 'A "quote" inside a string';
let string5 = "Another 'quote' inside a string";
...
//array of objects  example   representing studnets with their names and scores
let students = [
  { name: "Bhai", marks: 34 },
  { name: "clydeKing", marks: 47 },
  { name: "dasuyaKing", marks: 67 },
  { name: "Mpower", marks: 30 },
  { name: "Havelli", marks: 41 },
];

// using filter to get students with marks > 40

let passStudents = students.filter((stu) => stu.marks > 40);

// let passStudents = students.filter((stu) => {
//   return stu.marks > 40;
// });
console.log("passed students are", passStudents);
console.log(students[1].marks);
console.log(students[2]);
//update passed students name to Uppercase

let UpperCasearry = passStudents.map((student) => student.name.toUpperCase());
console.log(UpperCasearry);

// let use reduce(accumulator, currentValue) to calculate total marks of passed students

let totalMarks = passStudents.reduce((total, student) => {
  return total + student.marks;
}, 0);
console.log(totalMarks);

let totalMarks2 = passStudents.reduce(function (sum, student) {
  return (sum = sum + student.marks);
}, 0);
